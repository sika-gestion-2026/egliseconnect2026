  ...
  return (
    <div className="max-w-4xl mx-auto pb-12">
      <div className="mb-6 flex items-center gap-4">
        <Link href="/dashboard/members" className="text-gray-500 hover:text-primary-900 dark:hover:text-gold-400 font-bold transition-colors">
          &larr; Retour
        </Link>
        <h1 className="text-2xl font-serif text-primary-900 dark:text-gold-400">Nouvelle Fiche Membre</h1>
      </div>
      
      <form action={addMember} className="bg-white dark:bg-slate-800 rounded-xl shadow-sm p-8 border-t-4 border-gold-500 space-y-8">
        
        {/* Photo du membre */}
        <PhotoUploadPreview name="photo_file" />
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input name="first_name" required type="text" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700" placeholder="Ex: Christian" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Nom <span className="text-accent-500">*</span></label>
              <input name="last_name" required type="text" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700" placeholder="Ex: Munoko" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Sexe / Genre</label>
              <select name="gender" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700">
            ...
            <div>
              ...
              <input name="birth_date" type="date" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Téléphone (Appel direct)</label>
              <input name="phone" type="tel" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700" placeholder="Ex: +225..." />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Adresse Email</label>
              <input name="email" type="email" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700" placeholder="Ex: nom@domaine.com" />
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select name="status" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700">
            ...
            <div>
              ...
              <select name="baptized" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700">
            ...
            <div className="md:col-span-2">
              ...
              <input name="baptism_church" type="text" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700" placeholder="Ex: Église source de bénédictions" />
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {churchFunctions.map((fn, idx) => (
                <label key={idx} className="flex items-center gap-3 p-3 border rounded-lg hover:bg-slate-50 dark:hover:bg-slate-750 transition-colors cursor-pointer text-sm">
                  <input type="checkbox" name="functions" value={fn} className="w-4 h-4 accent-primary-900" />
                  <span>{fn}</span>
                </label>
              ))}
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <select name="marital_status" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700">
            ...
            <div>
              ...
              <input name="children_count" type="number" min={0} defaultValue={0} className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Profession / Emploi</label>
              <input name="profession" type="text" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700" placeholder="Ex: Comptable" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Commune</label>
              <input name="commune" type="text" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700" placeholder="Ex: Cocody" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Quartier</label>
              <input name="quartier" type="text" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700" placeholder="Ex: Angré" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-1">Contact d'urgence (Nom + Numéro)</label>
              <input name="emergency_contact" type="text" className="w-full px-3 py-2 border rounded-md dark:bg-slate-900 dark:border-slate-700" placeholder="Ex: Marie (Conjointe) +225..." />
            </div>
          </div>
        </div>
        ...
        {/* Actions */}
        <FormActions cancelUrl="/dashboard/members" submitText="Enregistrer le membre" />
