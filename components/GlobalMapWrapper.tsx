...
const GlobalMapComponent = dynamic(() => import('@/components/GlobalMapComponent'), { 
  ssr: false,
  loading: () => (
    <div className="w-full h-[600px] bg-slate-100 dark:bg-slate-800 rounded-2xl flex flex-col items-center justify-center animate-pulse border border-slate-200 dark:border-slate-700 shadow-inner">
